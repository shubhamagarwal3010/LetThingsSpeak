package com.iot.letthingsspeak.device.configuration.utils;
...
public class BarcodeReader extends Fragment implements View.OnTouchListener, BarcodeGraphicTracker.BarcodeGraphicTrackerListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(info.androidhive.barcode.R.layout.fragment_barcode_reader, container, false);
        permissionStatus = getActivity().getSharedPreferences("permissionStatus", getActivity().MODE_PRIVATE);
        mPreview = view.findViewById(info.androidhive.barcode.R.id.preview);
        mGraphicOverlay = view.findViewById(info.androidhive.barcode.R.id.graphicOverlay);
